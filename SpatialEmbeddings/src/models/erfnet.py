...
class seed_layer(nn.Module):
    def __init__(self, noutput):
        ...
        self.layer = nn.ConvTranspose2d(
            16, noutput, 2, stride=2, padding=0, output_padding=0, bias=True)
...
class Decoder(nn.Module):
    def __init__(self, num_classes):
        ...
        self.layers.append(non_bottleneck_1d(64, 0, 2))
        self.layers.append(non_bottleneck_1d(64, 0, 4))

        self.layers.append(UpsamplerBlock(64, 16))
        self.layers.append(non_bottleneck_1d(16, 0, 8))
        self.layers.append(non_bottleneck_1d(16, 0, 16))
    ...
    def forward(self, input):
        ...
        output_layer = self.output_conv(output)
